...
func newParserTSKVLb(in *ParserConfigTSKVLb, sniff bool, logger log.Logger) (*generic_parser.GenericParserConfig, []abstract.ColSchema, parsers_resources.AbstractResources, error) {
...
func newParserTSKVCommon(in *ParserConfigTSKVCommon, sniff bool, logger log.Logger) (*generic_parser.GenericParserConfig, []abstract.ColSchema, parsers_resources.AbstractResources, error) {
	resourcesObj, err := parsers_resources.NewResources(logger, []string{in.SchemaResourceName})
	if err != nil {
		return nil, nil, nil, xerrors.Errorf("unable to get resources, err: %w", err)
	}
