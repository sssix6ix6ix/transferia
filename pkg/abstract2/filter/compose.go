...
type IntersectFilter struct {
	subFilters []abstract2.DataObjectFilter
}

func (c *IntersectFilter) Includes(obj abstract2.DataObject) (bool, error) {
...
func NewIntersect(subFilters ...abstract2.DataObjectFilter) *IntersectFilter {
