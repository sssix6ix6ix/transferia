...
type ColumnValues interface {
	Value(i int) abstract2.Value
	Column() abstract2.Column
}

type baseValues struct {
	values []abstract2.Value
	col    abstract2.Column
}

func (b baseValues) Value(i int) abstract2.Value {
	return b.values[i]
}

func (b baseValues) Column() abstract2.Column {
	return b.col
}

type TableEventsBuilder interface {
	AddRow() RowBuilder
	AsBatch() abstract2.EventBatch
}
...
func (e insertBatchEvent) Table() abstract2.Table {
...
func (e insertBatchEvent) NewValue(i int) (abstract2.Value, error) {
	return e.batch.cols[e.iter].values[i], nil
}

func (b *insertsBatch) Event() (abstract2.Event, error) {
...
func (t *tableEventsBuilder) AsBatch() abstract2.EventBatch {
	return &insertsBatch{
		table:  t.table,
		cols:   t.cols,
		colIDX: t.colIDX,
...
func (r rowBuilder) AddValue(val abstract2.Value) {
	r.tableBuilder.cols[r.tableBuilder.colIDX[val.Column().FullName()]].values[r.rowIDX] = val
}

func NewTableEventsBuilder(table abstract2.Table) TableEventsBuilder {
	colIDX := map[string]int{}
