...
func (l *legacyTableAdapter) Column(i int) abstract2.Column {
...
func (l *legacyTableAdapter) ColumnByName(name string) abstract2.Column {
	return &legacyColumnAdapter{
...
func (l legacyColumnAdapter) Value(val interface{}) (abstract2.Value, error) {
	if val == nil {
		switch l.Type().(type) {
...
func (l legacyColumnAdapter) Table() abstract2.Table {
	return l.table
}
...
func NewTableFromLegacy(cols *abstract.TableSchema, table abstract.TableID) abstract2.Table {
	colNamesIDX := map[string]int{}
