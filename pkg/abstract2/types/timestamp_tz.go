...
func (typ *TimestampTZType) Cast(value abstract2.Value) (TimestampTZValue, error) {
...
func (typ *TimestampTZType) Validate(value abstract2.Value) error {
...
func NewDefaultTimestampTZValue(value *time.Time, column abstract2.Column) *DefaultTimestampTZValue {
...
func (value *DefaultTimestampTZValue) Column() abstract2.Column {
	return value.column
}
